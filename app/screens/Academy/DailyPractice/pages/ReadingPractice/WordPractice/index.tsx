...
const WordPractice = () => {
  ...
  if (!currentActivityId) {
    return (
      <Page
        title="Word Practice"
        description="Focus on articulation and clarity with individual words."
        onBack={() =>
          from === "MOOD_CHECK"
          ...
          >
            ...
            >
              <View style={styles.headerTopRow}>
                ...
                >
                  <Icon name={icons.spokeUp} size={12} color={colors.text.primary} />
              ...
              <View style={styles.headerWatermark} pointerEvents="none">
                <Icon name={icons.spokeUp} size={96} color={colors.accentOn.info} />
              </View>
            </View>
            ...
            >
              ...
              <View style={styles.sheetWatermarkContainer} pointerEvents="none">
                <Icon name={icons.spokeUp} size={120} color={colors.text.primary} />
              </View>
