...
const PhrasePractice = () => {
  ...
  const route = useRoute<RDPStackRouteProp<"PhrasePractice">>();
  ...
  const renderHighlightedText = () => {
    const practiceText = currentPhrase?.textContent || "";
    ...
    return (
      <ScreenView style={[styles.screenView, { backgroundColor: "#FAFAFA" }]}>
        ...
        >
          ...
          <Text style={styles.screenHeaderTitle}>Phrase Practice</Text>
          <View style={{ width: 32 }} />
        </BlurView>
        ...
        >
          <View style={styles.heroSection}>
            <Text style={styles.heroTitle}>Phrase Practice</Text>
            <Text style={styles.heroDescription}>
              Practice fluid transitions and natural pacing with full phrases.
            </Text>
          </View>
          ...
          <View style={styles.timelineSection}>
            ...
            <View style={styles.timelineContainer}>
              {readingTips.phrase.map((tip, index, arr) => (
            ...
            >
              <View style={styles.headerTopRow}>
                <View style={styles.categoryPill}>
                  <Icon name="comment-dots" size={12} color="#064E3B" />
                  <Text style={styles.categoryPillText}>PHRASE</Text>
                </View>
            ...
            <View style={styles.cardBodySheet}>
              ...
              <View style={styles.sheetWatermarkContainer}>
                <Icon
                  name="comment-dots"
                  size={120}
                  color={theme.colors.library.green[100]}
                />
              </View>
...
const styles = StyleSheet.create({
  ...
  dockItemActive: {
    backgroundColor: theme.colors.library.green[400],
