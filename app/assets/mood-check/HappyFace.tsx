...
const HappyFace = ({ size = 48, width, height, shouldAnimate, loop, repeatCount, ...props }: SvgIconProps) => {
    ...
    >
      <Defs>
        <Filter
          ...
          // Changing these to percentages ensures the filter area is
          // large enough to catch the shadow, regardless of scaling.
          x="-50%"
          y="-50%"
          width="200%"
          height="200%"
